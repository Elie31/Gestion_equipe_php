...
<body>
	...
	<form enctype="multipart/form-data" action="../php/ajout.php" method="post">
		NumLicense : <input type="number_format" name="num_licence" maxlength="9" minlength="9" placeholder="Numero a 9 chiffres" required pattern="[0-9]{9}" required autofocus><br/>
