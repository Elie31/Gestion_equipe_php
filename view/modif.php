...
<body>
	...
	<form action="../php/actionModif.php" method="post">
		...
		Taille : <input type="number" value = "<?php echo $taille ?> " step="0.01" name="taille" required autofocus><br/>
		Poids : <input type="number" value = "<?php echo $poids ?> " step="0.01" name="poids"  required autofocus><br/>
