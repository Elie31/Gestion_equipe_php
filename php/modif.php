...
<body>
	...
	<form action="../php/actionModif.php" method="post">
		...
		Taille : <input type="number" name="taille" placeholder="cm" value = "<?php echo $taille ?> " required autofocus><br/>
		Poids : <input type="number" name="poids" placeholder="kg" step="0.01" value = "<?php echo $poids ?> " required autofocus><br/>
